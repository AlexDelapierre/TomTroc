            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6 py-5">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control" placeholder="Description" rows="4" required><?= htmlspecialchars($_POST['description'] ?? ($isEdit ? $book->getDescription() : '')) ?></textarea>
                        <div class="mb-3">
